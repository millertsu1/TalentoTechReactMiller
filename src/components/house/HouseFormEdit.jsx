...
import { useGetHouseByCodeQuery, useUpdateHouseMutation } from '../../features/api/apiHousesSlice';
...
export default function HouseFormEdit(){
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();        
        const house = {
            _id: params._id, // Seteamos en _id por el que me llega como parametro
